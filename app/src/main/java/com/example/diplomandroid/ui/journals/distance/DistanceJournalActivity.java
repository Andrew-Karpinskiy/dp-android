...
public class DistanceJournalActivity extends AppCompatActivity {
    public static Map<String, String> distanceJournal = new HashMap<>();
    private DistanceJournalViewModel distanceJournalViewModel;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_distance_journal);
        distanceJournalViewModel = new ViewModelProvider(this,
                ViewModelProvider.AndroidViewModelFactory.getInstance(this.getApplication())).get(DistanceJournalViewModel.class);

        TextView newEntity = findViewById(R.id.djNewButton);
            ...
            mDialogBuilder
                    ...
                    .setPositiveButton(R.string.ok,
                            (dialog, id) -> {
                                ...
                                distanceJournalViewModel.saveDistance(this, weight, date.toString());
                            })
        ...
        TextView range = findViewById(R.id.djSelectButton);
            ...
            builder.setTitle(R.string.range)
                    ...
                    .setPositiveButton(R.string.ok, (dialog, id) -> {
                        ...
                        if (checkedItemsArray[0]) {
                            ...
                            distanceJournalViewModel.getDistance(this, date.toString());
                        } else {
        ...
        if (distanceJournal.size() > 0) {
            for (String key : distanceJournal.keySet()) {
                try {
                    Date date = new SimpleDateFormat("yyyy-MM-dd hh:mm:ss").parse(key);
                    Integer value = Integer.parseInt(distanceJournal.get(key));
                    data.put(date, value);
